...
<head>
  ...
  @include('includes.head')
    <meta property="og:url"           content="http://test.apsoc.gov.af/news_details/{{$id}}" />
    <meta property="og:type"          content="website" />
    <meta property="og:title"         content="{{ $title }}" />
    <meta property="og:description"   content="{{ $text }}" />
    <meta property="og:image"         content="http://test.apsoc.gov.af/assets/img/news/{{$news->photo}}" />
          ...
          <div class="col-lg-8 entries">
            ...
            <div class="blog-author d-flex align-items-center">
              <div class="col-md-12 text-center">
                  <div class="fb-share-button" data-href="http://kabulsilo.gov.af/news_details/{{$id}}" data-layout="button" data-size="large"><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fdevelopers.facebook.com%2Fdocs%2Fplugins%2F&amp;src=sdkpreparse" class="fb-xfbml-parse-ignore">Share</a></div>
                
                  <button id="whatsapp_btn" dir="ltr" type="button" class="btn btn-success"><i class="bi bi-whatsapp"></i> <a target="_blank" style="position:relative;top:-2px;" href="https://web.whatsapp.com/send?text=http://kabulsilo.gov.af/news_details/{{$id}}" data-action="share/whatsapp/share">Whatsapp</a></button>
              </div>
...
<?php } ?>
              ...
              <div class="reply-form">
                <h4>@lang('labels.leave_a_comment')</h4>
                <form id="comment_form">
                   @csrf
                   <input type="hidden" name="news_id" value="{{$id}}">
                  <div class="row">
                    <div class="col-md-6 form-group">
                      <input name="name" type="text" class="form-control name" placeholder="@lang('labels.name')" required>
                    </div>
                    <div class="col-md-6 form-group">
                      <input name="contact" type="text" class="form-control contact" placeholder="@lang('labels.email_or_phone')" required>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col form-group">
                      <textarea name="comment" required class="form-control msg" placeholder="@lang('labels.write_comment')" rows="4"></textarea>
                    </div>
                  </div>
                  <div class="row text-center">
                    <div class="loading"> @lang('labels.loading') </div>
                    <div class="error-message" style="text-align: center !important;">@lang('labels.comment_not_sended')</div>
                    <div class="sent-message" style="text-align: center !important;">@lang('labels.comment_sended')</div>

                    <button type="submit" class="btn btn-success" style="background-color: #1bbd36;border-color: #1bbd36;max-width:150px;margin: 0 auto;margin-top: 10px;">@lang('labels.send_comment')</button>
                  </div>
                </form>
...
<?php } ?>
 ...
 @include('includes.script')
  <script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_US/sdk.js#xfbml=1&version=v8.0" nonce="s3XuoevI"></script>
</body>
